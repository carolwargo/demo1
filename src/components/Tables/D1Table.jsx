...
const [orderBy, setOrderBy] = useState('count'); // Default sorting column
  ...
  return (
    <div className=' w3-light-gray' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
    <div className="container-fluid w3-padding-64 w3-text-black w3-margin-top">
      <div className="container-fluid text-center">
        <h5 className="mb-0 fw-bold"><b>Division I Schools</b></h5>
        <p className='small'>
        Schools listed were pulled direct from NCAA website.{' '}
          <a
            href="https://web3.ncaa.org/directory/memberList?type=12&division=I"
            className="mt-0 w3-text-blue w3-hover-opacity small text-decoration-underline"
          >
...
> <Table aria-label="custom pagination table">
  ...
  {stableSort(
    ...
    <StyledTableRow key={row.count}>
      <StyledTableCell sx={{ padding: '7px', lineHeight: '1.1', textAlign: 'center' }}>
        {row.count}
      </StyledTableCell>
      <StyledTableCell sx={{ padding: '7px', lineHeight: '1.1' }}>
        {row.state}
      </StyledTableCell>
      <StyledTableCell sx={{ padding: '7px', lineHeight: '1.1' }}>
        {row.institution}
